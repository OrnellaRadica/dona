...
function CategoriesBlock() {
  ...
  return (
    <div className=" grid grid-rows-2 grid-cols-2 gap-4 ">
      <a href="/ropa" className={categoryClass + " category3"}>
        <svg
      ...
      <a href="/muebles" className={categoryClass + " category"}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          enable-background="new 0 0 24 24"
          height="48px"
      ...
      <a href="/alimentos" className={categoryClass + " category2"}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          enable-background="new 0 0 24 24"
          height="48px"
      ...
      <a href="/juguetes" className={categoryClass + " category1"}>
        <svg
          xmlns="http://www.w3.org/2000/svg"
          enable-background="new 0 0 24 24"
          height="48px"
        ...
        >
          <g display="none">
            <rect display="inline" fill="none" height="24" width="24" y="0" />
          </g>
          <g>
            <g>
